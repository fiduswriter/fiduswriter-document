...
describe("DOCX Importer modules", () => {
    describe("DocxParser", () => {
        ...
        beforeAll(async () => {
            const mod = await import("../../src/importer/docx/parse.js")
    ...
    describe("DocxConvert", () => {
        ...
        beforeAll(async () => {
            const mod = await import("../../src/importer/docx/convert.js")
...
describe("ODT Importer modules", () => {
    describe("OdtConvert", () => {
        ...
        beforeAll(async () => {
            const mod = await import("../../src/importer/odt/convert.js")
    ...
    describe("DOCX document.xml parsing", () => {
        ...
        <w:document xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
          <w:body>
            ...
            const {xmlDOM} = await import("../../src/exporter/tools/xml.js")
        ...
        const sampleDoc = JSON.parse(
            readFileSync(
                join(
                    ...
                    "../exporter/fixtures/sample-doc.json"
                ),
                "utf-8"
            )
        )
